...
static const char col_black[]       = "#0d1117";
static const char col_white[]       = "#e6edf3";
static const char col_gray0[]       = "#4d4d4d";
static const char col_blue[]        = "#2f81f7";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_white, col_black, col_gray0 },
